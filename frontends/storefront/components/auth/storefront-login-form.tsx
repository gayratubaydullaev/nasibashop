...
export function StorefrontLoginForm({ nextPath }: Props) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div className="space-y-1">
        <label className="text-xs font-medium text-zinc-600" htmlFor="sf-email">
          Email
        </label>
        <input
          id="sf-email"
      ...
      <div className="space-y-1">
        <label className="text-xs font-medium text-zinc-600" htmlFor="sf-password">
          Пароль
        </label>
        <input
          id="sf-password"
